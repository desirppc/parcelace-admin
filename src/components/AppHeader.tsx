...
import { Wallet, Settings, User, ChevronDown, LogOut, Sun, Moon, Search, Plus, CreditCard, Loader2, Sparkles, Package, Calendar, MapPin } from 'lucide-react';
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-purple-200 dark:border-purple-800 z-[70] animate-fade-in min-w-[400px]">
            ...
            <div className="grid grid-cols-2 gap-0">
              <div className="p-2">
                <DropdownMenuItem onClick={() => navigate('/dashboard/settings/brand-details')} className="hover:bg-purple-50 dark:hover:bg-purple-900/20 cursor-pointer rounded-md mx-2 mb-1">
                  Brand Details
                </DropdownMenuItem>
