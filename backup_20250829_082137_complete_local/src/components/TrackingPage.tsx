...
const TrackingPage = () => {
  ...
  const hotSellingProducts = [
    { id: 1, name: "Premium Wireless Headphones", price: "₹2,999", image: "/placeholder.svg" },
    { id: 2, name: "Smart Fitness Watch", price: "₹4,599", image: "/placeholder.svg" },
    { id: 3, name: "Bluetooth Speaker", price: "₹1,899", image: "/placeholder.svg" },
    { id: 4, name: "Phone Case Pro", price: "₹799", image: "/placeholder.svg" },
    { id: 5, name: "Wireless Charger", price: "₹1,299", image: "/placeholder.svg" },
    { id: 6, name: "Gaming Mouse", price: "₹2,199", image: "/placeholder.svg" },
    { id: 7, name: "USB-C Hub", price: "₹1,599", image: "/placeholder.svg" },
  ];

  const instagramFeeds = [
    { id: 1, image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8", caption: "New collection drop! 🔥", likes: 1234 },
    { id: 2, image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30", caption: "Style meets comfort ✨", likes: 987 },
    { id: 3, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff", caption: "Weekend vibes 💫", likes: 2156 },
    { id: 4, image: "https://images.unsplash.com/photo-1549298916-b41d501d3772", caption: "Fresh arrivals 🌟", likes: 876 },
    { id: 5, image: "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a", caption: "Perfect fit guaranteed 💯", likes: 1543 },
    { id: 6, image: "https://images.unsplash.com/photo-1560472354-b33ff0c44a43", caption: "Trending now 📈", likes: 2087 },
  ];

  const mockOrder = {
    tracking: [
      { status: "Yet to Pickup", description: "Package details changed by Delhivery", location: "Ramtek_ShivajiWard_D (Maharashtra)", timestamp: "2025-07-02T21:12:20Z", isCompleted: false, isActive: false },
      { status: "Pickup scheduled", description: "Package is scheduled for pickup", location: "Alwar_TuleraRoad_D (Rajasthan)", timestamp: "2025-07-12T21:12:30Z", isCompleted: false, isActive: false },
      { status: "Out for pickup", description: "Package is out for pickup", location: "Alwar_TuleraRoad_D (Rajasthan)", timestamp: "2025-07-13T08:48:25Z", isCompleted: true, isActive: false },
      { status: "In Transit", description: "Package is on the way to destination", location: "Gurgaon_PalamVihar_C (Haryana)", timestamp: "2025-07-18T16:32:17Z", isCompleted: false, isActive: true },
      { status: "Out for Delivery", description: "Package will be delivered today", location: "Delhi_Central (Delhi)", timestamp: null, isCompleted: false, isActive: false },
      { status: "Delivered", description: "Package delivered successfully", location: "Delhi_Central (Delhi)", timestamp: null, isCompleted: false, isActive: false },
    ]
  };
            ...
            <CardContent className="p-6 relative">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={handleShare} className="text-gray-600 hover:bg-gray-200/80 h-8 w-8 p-0 rounded transition-colors duration-200 flex items-center justify-center">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  <Button onClick={handleArrangeReturn} className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 hover:from-blue-600 hover:to-indigo-700 font-medium transition-all duration-200 shadow-md hover:shadow-lg">
                    Request return
                  </Button>
                </div>
              </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="relative max-w-2xl mx-auto">
                <div className="relative aspect-video bg-gray-900 rounded-xl overflow-hidden shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5" alt="Product Launch Video" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <Button size="lg" className="bg-white/90 hover:bg-white text-gray-900 rounded-full h-16 w-16 p-0">
                  ...
                  <CardContent className="p-3">
                    <div className="space-y-2">
                      <div className="aspect-square relative overflow-hidden rounded-lg">
                        <img src={feed.image} alt="Instagram post" className="w-full h-full object-cover" />
                      </div>
                      <div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button onClick={handleNpsSubmit} disabled={npsScore === null} className="bg-blue-600 hover:bg-blue-700 px-8 py-2">
                    Submit
                  </Button>
                </div>
              </div>
        ...
        <Card className="mb-8 shadow-sm border-0 bg-gradient-to-br from-white to-green-50">
          <CardContent className="p-8">
            ...
            <div className="text-center">
              <Button onClick={handleDeliveryRatingSubmit} disabled={deliveryRating === null} className="bg-blue-600 hover:bg-blue-700 px-8 py-2">
                Submit
              </Button>
            </div>
          </CardContent>
